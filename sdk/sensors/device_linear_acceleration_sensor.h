 ...
 */
#ifndef CARDBOARD_SDK_SENSORS_DEVICE_LINEAR_ACCELERATION_SENSOR_H_
#define CARDBOARD_SDK_SENSORS_DEVICE_LINEAR_ACCELERATION_SENSOR_H_
...
// framework.
class DeviceLinearAccelerationSensor {
 public:
  DeviceLinearAccelerationSensor();
  ...
  void PollForSensorData(int timeout_ms,
                         std::vector<LinearAccelerationData>* results) const;
...
#endif  // CARDBOARD_SDK_SENSORS_DEVICE_LINEAR_ACCELERATION_SENSOR_H_
