 ...
 */
#ifndef CARDBOARD_SDK_SENSORS_DEVICE_POSE_6DOF_SENSOR_H_
#define CARDBOARD_SDK_SENSORS_DEVICE_POSE_6DOF_SENSOR_H_
...
// framework.
class DevicePose6DOFSensor {
 public:
  DevicePose6DOFSensor();
  ...
  void PollForSensorData(int timeout_ms,
                         std::vector<Pose6DOFData>* results) const;
...
#endif  // CARDBOARD_SDK_SENSORS_DEVICE_POSE_6DOF_SENSOR_H_
